  ...
  return (
    <header className="glass-nav relative z-30 flex h-nav shrink-0 items-center justify-between border-b border-surface-border px-6">
      ...
      <div className="flex items-center gap-4">
        <Link
          href="/generate"
          className="flex h-9 w-9 items-center justify-center rounded-lg border border-[#E7EAF5] text-[#667085] transition-all hover:border-[#F8BC42]/30 hover:bg-[rgba(248, 188, 66,0.08)] hover:text-[#F8BC42]"
        >
          <ArrowLeft size={16} />
        </Link>
      ...
      <div>
        {schema && (
          <div className="inline-flex items-center gap-1.5 rounded-full border border-[#E7EAF5] bg-[#FAFBFF] px-3 py-1.5 text-xs">
            ...
            <span className="rounded-md bg-[rgba(248, 188, 66,0.12)] px-2 py-0.5 text-[10px] font-bold text-[#F8BC42]">
              v{schema.version}
            </span>
          </div>
        )}
      ...
      {/* Toast Alert */}
      {toastMsg && (
        <div className="absolute bottom-[-48px] left-1/2 flex -translate-x-1/2 items-center gap-1.5 rounded-lg border border-[#F8BC42]/30 bg-white px-4 py-2 text-xs font-medium text-[#F8BC42] shadow-card animate-fade-in-up">
          ...
          <div className="glass-panel relative w-full max-w-md overflow-hidden p-6 text-[#1A1F36]">
            ...
            {deployError ? (
              ...
              <div className="space-y-4 text-center py-4">
                ...
                <div className="pt-4 flex gap-3 justify-center">
                  <Button
                    ...
                    className="bg-[#F8BC42] hover:bg-[#E0A22B] text-white"
                  >
                    Retry Deployment
                  </Button>
              ...
              <div className="space-y-6 py-2">
                <div className="flex items-center gap-3">
                  <Loader2 className="animate-spin text-[#F8BC42] h-5 w-5" />
                ...
                <div className="space-y-3.5 pt-2">
                  {steps.map((label, idx) => {
                    ...
                    return (
                      ...
                      >
                        {isCompleted ? (
                          <CheckCircle2 size={15} className="text-[#F8BC42] shrink-0 mt-0.5" />
                        ) : isActive ? (
                          <Loader2 size={15} className="text-[#F8BC42] animate-spin shrink-0 mt-0.5" />
                        ) : (
                ...
                <div className="h-1.5 w-full overflow-hidden rounded-full bg-[#E7EAF5]">
                  <div
                    className="bg-gradient-to-r from-[#F8BC42] to-[#E0A22B] h-1.5 transition-all duration-500 rounded-full"
              ...
              <div className="space-y-5 text-center py-2">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[#F8BC42]/10 text-[#F8BC42]">
                  <CheckCircle2 size={36} className="drop-shadow-[0_0_10px_rgba(248, 188, 66,0.4)]" />
                </div>
                ...
                {deployUrl && (
                  <div className="flex items-center gap-2 rounded-lg border border-[#E7EAF5] bg-[#FAFBFF] p-2.5 text-xs">
                    ...
                    <button
                      ...
                      className="shrink-0 rounded p-1.5 text-[#667085] transition-colors hover:bg-[rgba(248, 188, 66,0.08)] hover:text-[#F8BC42]"
                      title="Copy live link"
                    >
                      {deployLinkCopied ? <Check size={14} className="text-[#F8BC42]" /> : <Copy size={14} />}
                    </button>
                  </div>
                )}
                ...
                <div className="pt-3 flex gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex-1 flex items-center justify-center gap-1.5 rounded-lg bg-[#F8BC42] hover:bg-[#E0A22B] px-4 py-2.5 text-xs font-semibold text-white transition-all text-center"
                  >
