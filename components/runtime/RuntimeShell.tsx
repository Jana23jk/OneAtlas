...
export function RuntimeShell({
  ...
  return (
    <div className="runtime-page-bg flex h-screen flex-col overflow-hidden">
      ...
      <div
        className="pointer-events-none absolute bottom-16 left-1/2 h-72 w-72 -translate-x-1/2 rounded-full bg-[#00D4FF]/8 blur-3xl animate-float"
        aria-hidden
      />
        ...
        <div className="mx-auto flex h-[72px] max-w-7xl flex-wrap items-center justify-between gap-4 px-6">
          <div className="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1.5 rounded-full border border-[#00D4B1]/30 bg-[rgba(0,212,177,0.1)] px-2.5 py-1 text-xs font-semibold text-[#00D4B1]">
          ...
          <div className="flex flex-1 flex-wrap items-center justify-end gap-2 sm:gap-3">
            ...
            >
              <Bell size={18} />
              <span className="absolute right-2 top-2 h-2 w-2 rounded-full bg-[#FF5996]" />
            </button>
            <button
              type="button"
            ...
            <div className="flex h-10 items-center gap-2 rounded-xl border border-[#E7EAF5] bg-white pl-1 pr-3">
              <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-[#635BFF] to-[#7A73FF] text-white">
                <User size={16} />
              </span>
              <span className="hidden text-xs font-semibold text-[#0A2540] sm:inline">Admin</span>
            </div>
          </div>
        </div>
      </header>
